...
def init_position():
    ...
    params.global_state["wait_white"] = robot.get_pose_saved("wait_white")
    ...
    robot.move(params.global_state["wait_white"])
...
def get_pose_from_square(square):
    ...
    x = a1.x + row * square_width
    y = a1.y - col * square_height
